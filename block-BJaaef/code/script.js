...
got.houses.forEach(function(elem){
    elem.people.forEach(function(elem2){
    li = document.createElement("li")
    li.setAttribute("class", "box")
    let img = document.createElement("img")
    img.src = elem2.image;
    let h2 = document.createElement("h2")
    h2.innerText = elem2.name;
    let para = document.createElement("p")
    para.innerText = elem2.description;
    let anchor = document.createElement("a")
    anchor.href = elem2.wikiLink;
    li.append(img,h2,para,anchor)
